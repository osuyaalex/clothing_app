...
class WomenShoes extends StatefulWidget {
  final List prods;
  const WomenShoes({Key? key, required this.prods}) : super(key: key);
...
class _WomenShoesState extends State<WomenShoes> {
  ...
  String _newItem = 'Shoes';

  @override
  Widget build(BuildContext context) {
    var results = widget.prods.where((element) => element['type'] =='shoes').toList();
    return Scaffold(
        appBar: AppBar(
                                ...
                                if(newValue != _newItem){
                                  switch(newValue){
                                    case 'Dresses': Navigator.push(context, MaterialPageRoute(builder: (context){
                                      return  WomenDresses(product: widget.prods);
                                    }));
                                    break;
                                    case 'Tops': Navigator.push(context, MaterialPageRoute(builder: (context){
                                      return  WomenTop(products: widget.prods);
                                    }));
                                  }
                                }
                                setState(() {
