...
class WomenTop extends StatefulWidget {
  final List products;
  const WomenTop({Key? key, required this.products}) : super(key: key);
...
class _WomenTopState extends State<WomenTop> {
    ...
    String _newItem = 'Tops';
    @override
    Widget build(BuildContext context) {
      var results = widget.products.where((element) => element['type'] =='tops').toList();
      return Scaffold(
          appBar: AppBar(
                            ...
                            child: DropdownButton2(
                                ...
                                onChanged: (newValue){
                                  ...
                                  if(newValue != _newItem){
                                    switch(newValue){
                                      case 'Dresses': Navigator.push(context, MaterialPageRoute(builder: (context){
                                        return  WomenDresses(product: widget.products);
                                      }));
                                      break;
                                      case 'Shoes': Navigator.push(context, MaterialPageRoute(builder: (context){
                                        return  WomenShoes(prods: widget.products,);
                                      }));
                                    }
                                  }
                                  setState(() {
