...
import '../../../../../drawer details/outer drawer details/outer_drawer_details.dart';
...
class WomanApparelOuter extends StatefulWidget {
  final List product;
  const WomanApparelOuter({Key? key, required this.product}) : super(key: key);

  @override
  State<WomanApparelOuter> createState() => _WomanApparelOuterState();
}

class _WomanApparelOuterState extends State<WomanApparelOuter> {
  bool listChange = true;
  String _newItem = 'Outer';
  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='outer').toList();
    return Scaffold(
        appBar: AppBar(
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return OuterDrawerDetails(results: results[index]);
                                }));
                              },
                              child: Container(
                                width: 250,
