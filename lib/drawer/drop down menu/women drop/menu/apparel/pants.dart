...
import '../../../../../drawer details/pants drawer details/pants_drawer_details.dart';
...
import 'outer.dart';
class WomanApparelPants extends StatefulWidget {
  final List product;
  const WomanApparelPants({Key? key, required this.product}) : super(key: key);

  @override
  State<WomanApparelPants> createState() => _WomanApparelPantsState();
}

class _WomanApparelPantsState extends State<WomanApparelPants> {
  bool listChange = true;
  String _newItem = 'Pants';
  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='pants').toList();
    return Scaffold(
        appBar: AppBar(
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return PantsDrawerDetails(results: results[index]);
                                }));
                              },
                              child: Container(
                                width: 250,
