...
import '../../../../../drawer details/denim drawer details/denim_drawer_details.dart';
...
import 'outer.dart';
class WomanApparelDenim extends StatefulWidget {
  final List product;
  const WomanApparelDenim({Key? key, required this.product}) : super(key: key);

  @override
  State<WomanApparelDenim> createState() => _WomanApparelDenimState();
}

class _WomanApparelDenimState extends State<WomanApparelDenim> {
  bool listChange = true;
  String _newItem = 'Denim';
  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='denim').toList();
    return Scaffold(
        appBar: AppBar(
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return DenimDrawerDetails(results: results[index]);
                                }));
                              },
                              child: Container(
                                width: 250,
