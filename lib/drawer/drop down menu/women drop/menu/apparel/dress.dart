...
import 'outer.dart';
class WomanAparelDress extends StatefulWidget {
  final List product;
  const WomanAparelDress({Key? key, required this.product}) : super(key: key);

  @override
  State<WomanAparelDress> createState() => _WomanAparelDressState();
}

class _WomanAparelDressState extends State<WomanAparelDress> {
  bool listChange = true;
  String _newItem = 'Dress';
  @override
