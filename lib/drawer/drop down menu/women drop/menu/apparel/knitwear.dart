...
import '../../../../../drawer details/knitwear drawer details/knitwear_drawer_details.dart';
...
import 'kids.dart';
import 'outer.dart';
class WomanApparelKnitWear extends StatefulWidget {
  final List product;
  const WomanApparelKnitWear({Key? key, required this.product}) : super(key: key);

  @override
  State<WomanApparelKnitWear> createState() => _WomanApparelKnitWearState();
}

class _WomanApparelKnitWearState extends State<WomanApparelKnitWear> {
  bool listChange = true;
  String _newItem = 'Knitwear';
  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='knitwear').toList();
    return Scaffold(
        appBar: AppBar(
                                ...
                                if(newValue != _newItem){
                                  switch(newValue){
                                    ...
                                    case 'T-Shirt': Navigator.push(context, MaterialPageRoute(builder: (context){
                                      return  WomanApparelTShirt(product: widget.product);
                                    }));
                                    break;
                    ...
                    itemBuilder: (BuildContext ctx, index){
                      return Padding(
                        ...
                        child: GestureDetector(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context){
                              return KnitWearDrawerDetails(results: results[index]);
                            }));
                          },
                          child: Column(
                            children: [
