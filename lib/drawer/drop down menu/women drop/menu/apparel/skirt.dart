...
import 'kids.dart';
import 'outer.dart';
class WomanApparelSkirt extends StatefulWidget {
  final List product;
  const WomanApparelSkirt({Key? key, required this.product}) : super(key: key);

  @override
  State<WomanApparelSkirt> createState() => _WomanApparelSkirtState();
}

class _WomanApparelSkirtState extends State<WomanApparelSkirt> {
  bool listChange = true;
  String _newItem = 'Skirt';
  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='skirt').toList();
    return Scaffold(
        appBar: AppBar(
