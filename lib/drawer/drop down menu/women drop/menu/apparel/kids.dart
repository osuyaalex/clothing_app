...
import '../../../../../drawer details/kids drawer details/kids_drawer_details.dart';
...
import 'dress.dart';
import 'outer.dart';
class WomanApparelKids extends StatefulWidget {
  final List product;
  const WomanApparelKids({Key? key, required this.product}) : super(key: key);

  @override
  State<WomanApparelKids> createState() => _WomanApparelKidsState();
}

class _WomanApparelKidsState extends State<WomanApparelKids> {
  bool listChange = true;
  String _newItem = 'Kids';
  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='kids').toList();
    return Scaffold(
        appBar: AppBar(
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return KidsDrawerDetails(results: results[index]);
                                }));
                              },
                              child: Container(
                                width: 250,
