...
import '../../../../../drawer details/blouse drawer details/blouse_drawer_details.dart';
import '../../../../../main_body/cart.dart';
import '../../../../explore_collections_drawer.dart';
import '../../women list/women_list.dart';
class WomanApparelBlouse extends StatefulWidget {
  final List product;
  const WomanApparelBlouse({Key? key, required this.product}) : super(key: key);

  @override
  State<WomanApparelBlouse> createState() => _WomanApparelBlouseState();
}

class _WomanApparelBlouseState extends State<WomanApparelBlouse> {
  bool listChange = true;
  String _newItem = 'Blouse';
  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='blouse').toList();
    return Scaffold(
        appBar: AppBar(
                    ...
                    itemBuilder: (BuildContext ctx, index){
                      return Padding(
                        ...
                        child: GestureDetector(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context){
                              return BlouseDrawerDetails(results: results[index]);
                            }));
                          },
                          child: Column(
                            children: [
