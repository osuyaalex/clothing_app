...
import 'package:clothing_app/drawer/drop%20down%20menu/women%20drop/menu/beauty/make_up.dart';
...
class WomenBeautyBodyCare extends StatefulWidget {
  final List product;
  const WomenBeautyBodyCare({Key? key, required this.product}) : super(key: key);

  @override
  State<WomenBeautyBodyCare> createState() => _WomenBeautyBodyCareState();
}

class _WomenBeautyBodyCareState extends State<WomenBeautyBodyCare> {
  bool listChange = true;

  String _newItem = 'BodyCare';

  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='body care').toList();
    return Scaffold(
        appBar: AppBar(
