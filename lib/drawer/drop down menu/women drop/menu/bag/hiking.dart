...
import '../../../../../drawer details/hiking_drawer_details/hiking_drawer_details.dart';
import '../../../../../main_body/cart.dart';
import '../../../../../title.dart';
import '../../../../explore_collections_drawer.dart';
import '../../women list/women_list.dart';
class WomenBagHiking extends StatefulWidget {
  final List product;
  const WomenBagHiking({Key? key, required this.product}) : super(key: key);

  @override
  State<WomenBagHiking> createState() => _WomenBagHikingState();
}

class _WomenBagHikingState extends State<WomenBagHiking> {
  bool listChange = true;

  String _newItem = 'Hiking';

  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='hiking bag').toList();
    return Scaffold(
        appBar: AppBar(
                                ...
                                if(newValue != _newItem){
                                  switch(newValue){
                                    case 'School': Navigator.push(context, MaterialPageRoute(builder: (context){
                                      return  WomenBagSchool(product: widget.product,);
                                    }));
                                    break;
                                    case 'Work': Navigator.push(context, MaterialPageRoute(builder: (context){
                                      return  WomenBagWork(product: widget.product,);
                                    }));
                                  }
                                }
                                setState(() {
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return HikingDrawerDetails(results: results[index]);
                                }));
                              },
                              child: Container(
                                width: 250,
