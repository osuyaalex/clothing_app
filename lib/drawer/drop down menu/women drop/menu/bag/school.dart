...
import '../../../../../drawer details/school dd/school_dd.dart';
import '../../../../../main_body/cart.dart';
import '../../../../../title.dart';
import '../../../../explore_collections_drawer.dart';
import '../../women list/women_list.dart';
class WomenBagSchool extends StatefulWidget {
 final List product;
  const WomenBagSchool({Key? key, required this.product}) : super(key: key);

  @override
  State<WomenBagSchool> createState() => _WomenBagSchoolState();
}

class _WomenBagSchoolState extends State<WomenBagSchool> {
  bool listChange = true;

  String _newItem = 'School';

  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='schoolbag').toList();
    return Scaffold(
        appBar: AppBar(
                                ...
                                if(newValue != _newItem){
                                  switch(newValue){
                                    ...
                                    case 'Hiking': Navigator.push(context, MaterialPageRoute(builder: (context){
                                      return  WomenBagHiking(product: widget.product,);
                                    }));
                                  }
                                }
                                setState(() {
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return SchoolDrawerDetails(results: results[index]);
                                }));
                              },
                              child: Container(
                                width: 250,
