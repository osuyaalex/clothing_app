...
import '../../../../../drawer details/work dd/work_dd.dart';
import '../../../../../main_body/cart.dart';
import '../../../../../title.dart';
import '../../../../explore_collections_drawer.dart';
class WomenBagWork extends StatefulWidget {
 final List product;
  const WomenBagWork({Key? key, required this.product}) : super(key: key);

  @override
  State<WomenBagWork> createState() => _WomenBagWorkState();
}

class _WomenBagWorkState extends State<WomenBagWork> {
  bool listChange = true;

  String _newItem = 'Work';

  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='suitcases').toList();
    return Scaffold(
        appBar: AppBar(
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return WorkDrawerDetails(results: results[index]);
                                }));
                              },
                              child: Container(
                                width: 250,
