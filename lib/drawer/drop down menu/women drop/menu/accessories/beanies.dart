...
class WomenAccessoriesBeanies extends StatefulWidget {
  final List product;
  const WomenAccessoriesBeanies({Key? key, required this.product}) : super(key: key);

  @override
  State<WomenAccessoriesBeanies> createState() => _WomenAccessoriesBeaniesState();
}

class _WomenAccessoriesBeaniesState extends State<WomenAccessoriesBeanies> {
  bool listChange = true;

  String _newItem = 'Beanies';

  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='beanies').toList();
    return Scaffold(
        appBar: AppBar(
