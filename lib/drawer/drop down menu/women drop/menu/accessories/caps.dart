...
import 'package:clothing_app/drawer/drop%20down%20menu/women%20drop/menu/accessories/belts.dart';
...
import '../../../../../drawer details/caps drawer details/caps_drawer_details.dart';
import '../../../../../main_body/cart.dart';
import '../../../../../title.dart';
import '../../../../explore_collections_drawer.dart';

class WomenAccessoriesCaps extends StatefulWidget {
  final List product;
  const WomenAccessoriesCaps({Key? key, required this.product}) : super(key: key);

  @override
  State<WomenAccessoriesCaps> createState() => _WomenAccessoriesCapsState();
}

class _WomenAccessoriesCapsState extends State<WomenAccessoriesCaps> {
  bool listChange = true;

  String _newItem = 'Caps';

  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='caps').toList();
    return Scaffold(
        appBar: AppBar(
                              ...
                              onChanged: (newValue){
                                ...
                                if(newValue != _newItem){
                                  switch(newValue){
                                    ...
                                    break;
                                    case 'Belts': Navigator.push(context, MaterialPageRoute(builder: (context){
                                      return  WomenAccessoriesBelts(product: widget.product,);
                                    }));
                                  }
                                }
                                setState(() {
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return CapsDrawerDetails(results: results[index]);
                                }));
                              },
                              child: Container(
                                width: 250,
