import 'package:clothing_app/drawer/drop%20down%20menu/women%20drop/menu/accessories/beanies.dart';
import 'package:clothing_app/drawer/drop%20down%20menu/women%20drop/menu/accessories/caps.dart';
...
import '../../../../../drawer details/belts drawer details/belts_drawer_details.dart';
import '../../../../../main_body/cart.dart';
import '../../../../../title.dart';
import '../../../../explore_collections_drawer.dart';

class WomenAccessoriesBelts extends StatefulWidget {
  final List product;
  const WomenAccessoriesBelts({Key? key, required this.product}) : super(key: key);

  @override
  State<WomenAccessoriesBelts> createState() => _WomenAccessoriesBeltsState();
}

class _WomenAccessoriesBeltsState extends State<WomenAccessoriesBelts> {
  bool listChange = true;

  String _newItem = 'Belts';

  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='belts').toList();
    return Scaffold(
        appBar: AppBar(
                          ...
                          child: DropdownButton2(
                              ...
                              onChanged: (newValue){
                                ...
                                if(newValue != _newItem){
                                  switch(newValue){
                                    case 'Beanies': Navigator.push(context, MaterialPageRoute(builder: (context){
                                      return  WomenAccessoriesBeanies(product: widget.product,);
                                    }));
                                    break;
                                    case 'Caps': Navigator.push(context, MaterialPageRoute(builder: (context){
                                      return  WomenAccessoriesCaps(product: widget.product,);
                                    }));
                                  }
                                }
                                setState(() {
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return BeltsDrawerDetails(results: results[index]);
                                }));
                              },
                              child: Container(
                                width: 250,
