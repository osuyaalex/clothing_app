...
import '../../../../../drawer details/boots drawer details/boots_drawer_details.dart';
import '../../../../../main_body/cart.dart';
import '../../../../../title.dart';
import '../../../../explore_collections_drawer.dart';
import '../../women list/women_list.dart';

class WomenShoesBoots extends StatefulWidget {
  final List product;
  const WomenShoesBoots({Key? key, required this.product}) : super(key: key);

  @override
  State<WomenShoesBoots> createState() => _WomenShoesBootsState();
}

class _WomenShoesBootsState extends State<WomenShoesBoots> {
  bool listChange = true;

  String _newItem = 'Boots';

  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='boots').toList();
    return Scaffold(
        appBar: AppBar(
                              ...
                              onChanged: (newValue){
                                ...
                                if(newValue != _newItem){
                                  switch(newValue){
                                    ...
                                    break;
                                    case 'Trainers': Navigator.push(context, MaterialPageRoute(builder: (context){
                                      return  WomenShoesTrainers(product: widget.product,);
                                    }));
                                  }
                                }
                                setState(() {
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return BootsDrawerDetails(results: results[index]);
                                }));
                              },
                              child: Container(
                                width: 250,
