...
import '../../../../../drawer details/heels_drawer_details/heels_drawer_details.dart';
import '../../../../../main_body/cart.dart';
import '../../../../../title.dart';
import '../../../../explore_collections_drawer.dart';
import '../../women list/women_list.dart';

class WomenShoesHeels extends StatefulWidget {
  final List product;
  const WomenShoesHeels({Key? key, required this.product}) : super(key: key);

  @override
  State<WomenShoesHeels> createState() => _WomenShoesHeelsState();
}

class _WomenShoesHeelsState extends State<WomenShoesHeels> {
  bool listChange = true;

  String _newItem = 'Heels';

  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='heels').toList();
    return Scaffold(
        appBar: AppBar(
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return HeelsDrawerDetails(results: results[index]);
                                }));
                              },
                              child: Container(
                                width: 250,
