...
import '../../../../../drawer details/trainers drawer details/trainers_drawer_details.dart';
import '../../../../../main_body/cart.dart';
import '../../../../../title.dart';
import '../../../../explore_collections_drawer.dart';
import '../../women list/women_list.dart';

class WomenShoesTrainers extends StatefulWidget {
  final List product;
  const WomenShoesTrainers({Key? key, required this.product}) : super(key: key);

  @override
  State<WomenShoesTrainers> createState() => _WomenShoesTrainersState();
}

class _WomenShoesTrainersState extends State<WomenShoesTrainers> {
  bool listChange = true;

  String _newItem = 'Trainers';

  @override
  Widget build(BuildContext context) {
    var results = widget.product.where((element) => element['type'] =='trainers').toList();
    return Scaffold(
        appBar: AppBar(
                      ...
                      Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton2(
                              ...
                              items: shoes.map<DropdownMenuItem>((value){
                              ...
                              onChanged: (newValue){
                                ...
                                if(newValue != _newItem){
                                  switch(newValue){
                                    case 'Boots': Navigator.push(context, MaterialPageRoute(builder: (context){
                                      return  WomenShoesBoots(product: widget.product,);
                                    }));
                                    break;
                                    case 'Heels': Navigator.push(context, MaterialPageRoute(builder: (context){
                                      return  WomenShoesHeels(product: widget.product,);
                                    }));
                                  }
                                }
                                setState(() {
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return TrainersDrawerDetails(results: results[index]);
                                }));
                              },
                              child: Container(
                                width: 250,
