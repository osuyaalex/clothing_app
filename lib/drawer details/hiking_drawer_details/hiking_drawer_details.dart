...
import 'hiking_also_like.dart';

class HikingDrawerDetails extends StatefulWidget {
  final dynamic results;
  const HikingDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<HikingDrawerDetails> createState() => _HikingDrawerDetailsState();
}

class _HikingDrawerDetailsState extends State<HikingDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return HikingAlsoLike(snapshot: snapshot);
                  }else{
