...
import 'package:clothing_app/drawer%20details/Tshirt%20drawer%20details/tshirt_also_like.dart';
...
class TShirtDrawerDetails extends StatefulWidget {
  final dynamic results;
  const TShirtDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<TShirtDrawerDetails> createState() => _TShirtDrawerDetailsState();
}

class _TShirtDrawerDetailsState extends State<TShirtDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return TShirtAlsoLike(snapshot: snapshot);
                  }else{
