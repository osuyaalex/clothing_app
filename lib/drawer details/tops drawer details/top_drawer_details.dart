...
import 'package:clothing_app/drawer%20details/tops%20drawer%20details/tops_also_like.dart';
...
class TopDrawerDetails extends StatefulWidget {
  final dynamic results;
  const TopDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<TopDrawerDetails> createState() => _TopDrawerDetailsState();
}

class _TopDrawerDetailsState extends State<TopDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return TopAlsoLike(snapshot: snapshot);
                  }else{
