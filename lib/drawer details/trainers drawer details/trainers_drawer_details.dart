...
import 'package:clothing_app/drawer%20details/trainers%20drawer%20details/trainers_also_like.dart';
...
class TrainersDrawerDetails extends StatefulWidget {
  final dynamic results;
  const TrainersDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<TrainersDrawerDetails> createState() => _TrainersDrawerDetailsState();
}

class _TrainersDrawerDetailsState extends State<TrainersDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return TrainersAlsoLike(snapshot: snapshot);
                  }else{
