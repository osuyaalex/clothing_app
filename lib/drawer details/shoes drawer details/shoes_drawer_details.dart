...
import 'package:clothing_app/drawer%20details/shoes%20drawer%20details/shoes_also_like.dart';
...
class ShoesDrawerDetails extends StatefulWidget {
  final dynamic results;
  const ShoesDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<ShoesDrawerDetails> createState() => _ShoesDrawerDetailsState();
}

class _ShoesDrawerDetailsState extends State<ShoesDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return ShoesAlsoLike(snapshot: snapshot);
                  }else{
