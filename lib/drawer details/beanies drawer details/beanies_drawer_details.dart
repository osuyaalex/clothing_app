...
import 'beanies_also_like.dart';

class BeaniesDrawerDetails extends StatefulWidget {
  final dynamic results;
  const BeaniesDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<BeaniesDrawerDetails> createState() => _BeaniesDrawerDetailsState();
}

class _BeaniesDrawerDetailsState extends State<BeaniesDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return BeaniesAlsoLike(snapshot: snapshot);
                  }else{
