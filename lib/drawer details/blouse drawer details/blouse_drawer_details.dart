...
import 'blouse_also_like.dart';

class BlouseDrawerDetails extends StatefulWidget {
  final dynamic results;
  const BlouseDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<BlouseDrawerDetails> createState() => _BlouseDrawerDetailsState();
}

class _BlouseDrawerDetailsState extends State<BlouseDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return BlouseAlsoLike(snapshot: snapshot);
                  }else{
