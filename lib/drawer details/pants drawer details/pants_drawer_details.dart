...
import 'package:clothing_app/drawer%20details/pants%20drawer%20details/pants_also_like.dart';
...
class PantsDrawerDetails extends StatefulWidget {
  final dynamic results;
  const PantsDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<PantsDrawerDetails> createState() => _PantsDrawerDetailsState();
}

class _PantsDrawerDetailsState extends State<PantsDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return PantsAlsoLike(snapshot: snapshot);
                  }else{
