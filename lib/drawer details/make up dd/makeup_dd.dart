...
import 'makeup_al.dart';

class MakeUpDrawerDetails extends StatefulWidget {
  final dynamic results;
  const MakeUpDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<MakeUpDrawerDetails> createState() => _MakeUpDrawerDetailsState();
}

class _MakeUpDrawerDetailsState extends State<MakeUpDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return MakeUpAlsoLike(snapshot: snapshot);
                  }else{
