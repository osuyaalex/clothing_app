...
import 'outer_also_like.dart';

class OuterDrawerDetails extends StatefulWidget {
  final dynamic results;
  const OuterDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<OuterDrawerDetails> createState() => _OuterDrawerDetailsState();
}

class _OuterDrawerDetailsState extends State<OuterDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return OuterAlsoLike(snapshot: snapshot);
                  }else{
