...
import 'knitwear_also_like.dart';

class KnitWearDrawerDetails extends StatefulWidget {
  final dynamic results;
  const KnitWearDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<KnitWearDrawerDetails> createState() => _KnitWearDrawerDetailsState();
}

class _KnitWearDrawerDetailsState extends State<KnitWearDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return KnitWearAlsoLike(snapshot: snapshot);
                  }else{
