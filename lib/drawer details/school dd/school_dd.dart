...
import 'package:clothing_app/drawer%20details/school%20dd/school_al.dart';
...
class SchoolDrawerDetails extends StatefulWidget {
  final dynamic results;
  const SchoolDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<SchoolDrawerDetails> createState() => _SchoolDrawerDetailsState();
}

class _SchoolDrawerDetailsState extends State<SchoolDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return SchoolAlsoLike(snapshot: snapshot);
                  }else{
