...
import 'bodycare_al.dart';

class BodyCareDrawerDetails extends StatefulWidget {
  final dynamic results;
  const BodyCareDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<BodyCareDrawerDetails> createState() => _BodyCareDrawerDetailsState();
}

class _BodyCareDrawerDetailsState extends State<BodyCareDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return BodyCareAlsoLike(snapshot: snapshot);
                  }else{
