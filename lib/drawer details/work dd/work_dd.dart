...
import 'package:clothing_app/drawer%20details/work%20dd/work_al.dart';
...
class WorkDrawerDetails extends StatefulWidget {
  final dynamic results;
  const WorkDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<WorkDrawerDetails> createState() => _WorkDrawerDetailsState();
}

class _WorkDrawerDetailsState extends State<WorkDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return WorkAlsoLike(snapshot: snapshot);
                  }else{
