...
import 'haircare_al.dart';

class HairCareDrawerDetails extends StatefulWidget {
  final dynamic results;
  const HairCareDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<HairCareDrawerDetails> createState() => _HairCareDrawerDetailsState();
}

class _HairCareDrawerDetailsState extends State<HairCareDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return HairCareAlsoLike(snapshot: snapshot);
                  }else{
