...
import 'heels_also_like.dart';

class HeelsDrawerDetails extends StatefulWidget {
  final dynamic results;
  const HeelsDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<HeelsDrawerDetails> createState() => _HeelsDrawerDetailsState();
}

class _HeelsDrawerDetailsState extends State<HeelsDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return HeelsAlsoLike(snapshot: snapshot);
                  }else{
