...
import 'package:clothing_app/drawer%20details/skirt%20dawer%20details/skirt_also_like.dart';
...
class SkirtDrawerDetails extends StatefulWidget {
  final dynamic results;
  const SkirtDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<SkirtDrawerDetails> createState() => _SkirtDrawerDetailsState();
}

class _SkirtDrawerDetailsState extends State<SkirtDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return SkirtAlsoLike(snapshot: snapshot);
                  }else{
