...
import 'belts_also_like.dart';

class BeltsDrawerDetails extends StatefulWidget {
  final dynamic results;
  const BeltsDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<BeltsDrawerDetails> createState() => _BeltsDrawerDetailsState();
}

class _BeltsDrawerDetailsState extends State<BeltsDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return BeltsAlsoLike(snapshot: snapshot);
                  }else{
