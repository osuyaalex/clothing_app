...
import 'denim_also_like.dart';

class DenimDrawerDetails extends StatefulWidget {
  final dynamic results;
  const DenimDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<DenimDrawerDetails> createState() => _DenimDrawerDetailsState();
}

class _DenimDrawerDetailsState extends State<DenimDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return DenimAlsoLike(snapshot: snapshot);
                  }else{
