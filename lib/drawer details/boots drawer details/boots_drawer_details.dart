...
import 'boots_also_like.dart';

class BootsDrawerDetails extends StatefulWidget {
  final dynamic results;
  const BootsDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<BootsDrawerDetails> createState() => _BootsDrawerDetailsState();
}

class _BootsDrawerDetailsState extends State<BootsDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return BootsAlsoLike(snapshot: snapshot);
                  }else{
