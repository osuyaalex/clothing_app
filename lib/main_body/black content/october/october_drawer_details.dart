...
import '../../cart.dart';
import 'october_also_like.dart';

class OctoberDrawerDetails extends StatefulWidget {
  final dynamic results;
  const OctoberDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<OctoberDrawerDetails> createState() => _OctoberDrawerDetailsState();
}

class _OctoberDrawerDetailsState extends State<OctoberDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return OctoberAlsoLike(snapshot: snapshot);
                  }else{
