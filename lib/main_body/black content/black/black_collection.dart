...
class BlackCollections extends StatefulWidget {
  const BlackCollections({Key? key}) : super(key: key);

  @override
  State<BlackCollections> createState() => _BlackCollectionsState();
}

class _BlackCollectionsState extends State<BlackCollections> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return BlackGrid(snapshot: snapshot);
                  }else{
