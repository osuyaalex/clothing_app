...
import '../../cart.dart';
import 'black_also_like.dart';

class BlackDrawerDetails extends StatefulWidget {
  final dynamic results;
  const BlackDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<BlackDrawerDetails> createState() => _BlackDrawerDetailsState();
}

class _BlackDrawerDetailsState extends State<BlackDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return BlackAlsoLike(snapshot: snapshot);
                  }else{
