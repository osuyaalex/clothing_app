...
import '../../cart.dart';
import 'hae_also_like.dart';

class HaeDrawerDetails extends StatefulWidget {
  final dynamic results;
  const HaeDrawerDetails({Key? key, required this.results}) : super(key: key);


  @override
  State<HaeDrawerDetails> createState() => _HaeDrawerDetailsState();
}

class _HaeDrawerDetailsState extends State<HaeDrawerDetails> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return HaeAlsoLike(snapshot: snapshot);
                  }else{
