...
import 'hae_grid.dart';


class HaeCollections extends StatefulWidget {
  const HaeCollections({Key? key}) : super(key: key);

  @override
  State<HaeCollections> createState() => _HaeCollectionsState();
}

class _HaeCollectionsState extends State<HaeCollections> {
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return HaeGrid(snapshot: snapshot);
                  }else{
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Align(
                              alignment: Alignment.centerLeft,
                              child: SvgPicture.asset(
                                'assets/iconImages/October collection.svg',
                                height: 15,
                              )
                          ),
                        )
